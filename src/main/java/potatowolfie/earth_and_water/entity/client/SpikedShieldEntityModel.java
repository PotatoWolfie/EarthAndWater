...
public class SpikedShieldEntityModel extends net.minecraft.client.render.entity.model.ShieldEntityModel {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData plate = modelPartData.addChild("plate", ModelPartBuilder.create().uv(0, 0).cuboid(-12.0F, -23.0F, 0.0F, 12.0F, 22.0F, 1.0F, new Dilation(0.0F))
				...
				.uv(0, 29).cuboid(-4.0F, -5.0F, -0.01F, 2.0F, 2.0F, 0.02F, new Dilation(0.0F)), ModelTransform.of(0.0F, -1.0F, 0.0F, 0.0F, 0.0F, -3.1416F));

		ModelPartData handle = modelPartData.addChild("handle", ModelPartBuilder.create().uv(26, 0).cuboid(-7.0F, -15.0F, 1.0F, 2.0F, 6.0F, 6.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -1.0F, 0.0F, 0.0F, 0.0F, -3.1416F));
